<template>
    <div class="app-container">
      ...
      <el-descriptions title="提供帮助者信息">
        <el-descriptions-item label="用户名">{{this.form.hedusername}}</el-descriptions-item>
        <el-descriptions-item label="姓名">{{this.form.hedname}}</el-descriptions-item>
        <el-descriptions-item label="联系方式">{{this.form.headphone}}</el-descriptions-item>
        <el-descriptions-item label="地址">{{this.form.hedaddress}}</el-descriptions-item>
        <el-descriptions-item label="详细信息">{{this.form.heddetail}}</el-descriptions-item>
        <el-descriptions-item label="帮助时间">{{this.form.updateTime}}</el-descriptions-item>
        </el-descriptions>
            ...
            if (this.form.hid != null) {
             ...
             // console.log(this.form);
              updateHelp({
                  ...
                  haddress:this.form.region1+this.form.region2+this.form.region3+this.form.address1,
